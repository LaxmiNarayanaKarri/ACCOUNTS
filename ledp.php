...
<label class="led">LEDGER IN PURCHASE:</label>
<label class="lad">click on any one to continue</label>
<button class="b1"><a href="ledpkgs.php" class="a">IN KGS</a></button>
<button class="b2"><a href="ledpboth.php" class="a">BOTH KGS AND BAGS</a></button>
<br>
<button class="b3"><a href="ledpbags.php" class="a">IN BAGS</a></button>
<button class="b4"><a href="ledpall.php" class="a">FOR ALL CUSTOMERS</a></button>
