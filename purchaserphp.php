...
$reg="insert into purchaser(purrname,purrdate,purrbill,purrnar,purrproductname,purrbags,purrqty,purrrate,purramount,purrnid) values('$cname','$sdate','$sbil','$nar','$pname','$bags','$qty','$rate','$amount','$s')";
