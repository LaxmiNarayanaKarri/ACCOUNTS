...
mysqli_select_db($con,'books');
	$zs="select MIN(id) from purchaser";
	$zresult=mysqli_query($con,$zs);
	$zbill=mysqli_fetch_array($zresult);
	$zbil=$zbill[0];
	$s="select purrbill from purchaser where id='$zbil' ";
	$result=mysqli_query($con,$s);
	$bill=mysqli_fetch_array($result);
	$bil=$bill[0];
	$ss="select * from purchaser where purrbill='$bil'";
...
<div class="salestable"> 
	...
	<tbody class="tbody" id="tbody">
		<?php
			$da="select * from purchaser where purrbill='$bil' ";
