...
mysqli_select_db($con,'books');
	$help= $_POST['help'];
	$bily=$help-1;
	$ss3="select sname from sales where sbill='$bily'";
	...
	$ss="select * from sales where sbill='$bily'";
	$res=mysqli_query($con,$ss);
	$re=mysqli_fetch_row($res);
	$s1="select MAX(sbill) from sales";
	...
	$srdat=$re[2];
	$srnar=$re[4];
	$ss1="select MIN(sbill) from sales";
	...
	<table class="table" id='table'>
	  	<thread class="thread">
			<tr>
				...
				<th>Amount</th>
		<?php
			$da="select * from sales where sbill='$bily' ";
...
<form method="post" action="salepre.php" name="f1" >
	...
	<input type="submit"  class="salenex" id="salenext" value="NEXT" onclick="f1.action='salenexbil.php';f1.target='_blank';">
