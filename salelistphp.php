...
<div class="salestable"> 
	...
	<tbody class="tbody" id="tbody">
		...
		if($td=='')
		{
			$zs="select max(sdate) from sales";
		...
		if($tb=='')
		{
			$sqw="select max(sbill) from sales";
		...
		if($fd=='')
		{
			$s2="select max(sdate) from sales";
		...
		if($fb=='')
		{
			$s3="select min(sbill) from sales";
		...
		if($na=='')
			{
				$da="select * from sales where sdate between '$fd' and '$td' and sbill between '$fb' and '$tb'";

			}

			if($na!='')
			{
				$da="select * from sales where sdate between '$fd' and '$td'  and sbill between '$fb' and '$tb' and sname='$na' ";
			}
