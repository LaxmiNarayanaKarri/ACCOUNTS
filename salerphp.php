...
$reg="insert into salesr(srname,srdate,srbill,srnar,srpnames,srbags,srqty,srrate,sramount,sracid,date) values('$cname','$sdate','$sbil','$nar','$pname','$bags','$qty','$rate','$amount','$s','$sdate')";
