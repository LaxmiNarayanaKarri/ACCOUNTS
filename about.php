...
<div class="about">
	<h1 class="huh"><span>SPECIALITY</span>
	<br>
	<p>
	    <br>
        .THIS PROJECT IS HIGHLY COMPOSED
        OF COMPLEX JAVASCRIPT COMMANDS
        <br>
        <br>
        .EVER LEDGER IN THIS PROJECT IS 
        IN PRINTABLE FORMAT
        <br>
        <br>
        .USED BEST CSS STYLE 
...
<div class="about">
	...
	<p>
		<br>
		.YOU CAN USE THE GUIDE IN THE HOME PAGE TO 
		USE THIS WEBSITE.
	</p>
	</h1>
</div>
<div class="link">
	...
	<ul class="dropdown" >
    		<li><a class="dropdown" href="home.php">HOME</a></li>
   			<li><a class="dropdown" href="account creation.php">ACCOUNT CREATION</a></li>
    		<li><a class="dropdown" href="ledger.php">LEDGER</a></li>
    </ul>
</div>
<div class="line">
